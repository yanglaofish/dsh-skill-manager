...
import { readdir, readFile, writeFile, mkdir, rename, unlink, copyFile, stat, lstat, readlink, symlink, link } from 'node:fs/promises';
...
// Look up one skill in the library.
async function findSkill(name) {
  const fileName = name.endsWith('.md') ? name : `${name}.md`;
  for (const dir of [skillsRoot()]) {
    try {
