...
// Read a directory-form skill: <root>/<dirName>/SKILL.md. The engine
// (dsh-skill-filesystem discoverRoot) supports this layout alongside
// single-file skills; this mirrors it so the manager sees both forms.
