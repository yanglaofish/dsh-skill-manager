...
async function linkGlobalSkillToWorkspace(cwd, skillName) {
  ...
  if (entry.form === 'dir') return { ok: false, error: `directory-form skill ${skillName} cannot be linked; copy the folder into the target workspace's .dsh/skills instead` };
  const dir = workspaceSkillDir(cwd);
