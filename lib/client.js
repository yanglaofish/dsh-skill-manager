...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		".dskm_fta{flex:1;width:100%;margin:0;padding:10px 14px;border:none;font-family:ui-monospace,Consolas,monospace;font-size:12px;line-height:17px;white-space:pre;overflow:auto;background:var(--dsw-specific-input);color:var(--dsw-alias-label-primary);resize:none;outline:none}";
			...
			return react.createElement("div", { className: "dskm_mask",
				...
				react.createElement("div", { className: "dskm_modal " + (isDir ? "dskm_modal_wide" : "") },
					...
					react.createElement("div", { className: "dskm_tabs" },
						...
						isDir ? react.createElement("button", { className: "dskm_tab " + (mode === "files" ? "dskm_tab_on" : ""), onClick: () => setMode("files") }, "📁 文件浏览") : null
					),
					mode === "preview"
										...
										? react.createElement(react.Fragment, null,
											react.createElement("div", { className: "dskm_ftbar" },
												...
												react.createElement("button", {
													className: "dskm_btn dskm_btnp dskm_ftsave",
													disabled: !fileDirty || fileSaving,
													onClick: saveFile,
												}, fileSaving ? "保存中…" : (fileDirty ? "保存 ✓" : "已保存"))
											),
											react.createElement("textarea", {
												className: "dskm_fta",
												value: fileDraft,
