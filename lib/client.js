...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
				...
				return react.createElement("div", { className: "dskm_layers" },
					...
					pg.items.map((r) => {
						...
						return react.createElement(SkillRow, {
							...
							name: r.name,
							desc: r.description || "",
							checked: true, // library entries are always present; enablement is per-workspace
							disabled: isPreset,
							notoggle: true,
							onToggle: null,
				...
				return react.createElement("div", { className: "dskm_layers" },
					...
					pg.items.map((s) => {
						...
						return react.createElement(SkillRow, {
							...
							notoggle: true, // library rows can't be toggled but keep bright buttons
							onToggle: null,
		...
		function SkillRow({ name, desc, checked, disabled, notoggle, onToggle, actions, tag, sub }) {
			const handleClick = (e) => {
