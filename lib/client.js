...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css =
			...
			".dskm_mode{flex:none;font-size:11px;line-height:20px;padding:0 10px;border-radius:20px;font-weight:600;white-space:nowrap;letter-spacing:.2px;user-select:none}" +
			".dskm_mode_follow{background:rgba(148,163,184,.12);color:var(--dsw-alias-label-secondary);border:1px solid rgba(148,163,184,.32)}" +
			".dskm_mode_pin{background:rgba(245,158,11,.14);color:#fbbf24;border:1px solid rgba(245,158,11,.45)}" +
