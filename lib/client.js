...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		".dskm_ftnode:hover{background:var(--dsw-alias-state-hover);border-color:var(--dsw-alias-border-l1)}" +
		".dskm_ftsel{background:rgba(16,185,129,.1);color:var(--dsw-alias-accent);border-color:rgba(16,185,129,.3)}" +
